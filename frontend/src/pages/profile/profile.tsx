...
export const Profile = () => {
  ...
  if (!user) {
    return (
      <div className="empty-state">
        ...
        <p className="empty-state-description">Please log in to view your profile</p>
  ...
  return (
    <div className="profile-section">
      ...
      <div className="profile-card">
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-4)" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "var(--space-3)" }}>
            ...
            <div>
              <p style={{ fontSize: "var(--text-xs)", color: "var(--gray-500)", marginBottom: "2px" }}>Full Name</p>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "var(--space-3)" }}>
            ...
            <div>
              <p style={{ fontSize: "var(--text-xs)", color: "var(--gray-500)", marginBottom: "2px" }}>Email Address</p>
          ...
          {user.phone && (
            <div style={{ display: "flex", alignItems: "center", gap: "var(--space-3)" }}>
              ...
              <div>
                <p style={{ fontSize: "var(--text-xs)", color: "var(--gray-500)", marginBottom: "2px" }}>Phone Number</p>
      ...
      {/* Logout */}
      <div className="profile-card" style={{ background: "var(--primary-50)", border: "1px solid var(--primary-100)" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div>
            <h4 style={{ fontWeight: "var(--font-semibold)", marginBottom: "var(--space-1)" }}>Sign out</h4>
