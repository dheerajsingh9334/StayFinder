...
import { Search, Radio, Rocket } from "lucide-react";
...
export default function HeroOrbitDeck() {
  ...
  const showcaseImage = {
    ...
    alt: "Futuristic and monochrome abstract geometric background",
  };
            ...
            <div className="flex gap-2">
              <button
                ...
                className={`flex-1 rounded-full border px-4 py-2 text-xs font-semibold uppercase tracking-[0.35em] transition ${
                  mode === "strategy" ? "bg-transparent text-black dark:bg-transparent/90 dark:text-black" : `${palette.border} ${palette.accent}`
                }`}
              >
                Strategy
              </button>
              <button
                ...
                className={`flex-1 rounded-full border px-4 py-2 text-xs font-semibold uppercase tracking-[0.35em] transition ${
                  mode === "execution" ? "bg-transparent text-black dark:bg-transparent/90 dark:text-black" : `${palette.border} ${palette.accent}`
                }`}
              >
                Execution
              </button>
        ...
        <div className="grid gap-10 xl:grid-cols-[minmax(0,0.9fr)_minmax(0,1.2fr)_minmax(0,0.9fr)] xl:items-stretch">
          ...
          <figure className="order-1 overflow-hidden rounded-[32px] border transition xl:order-2" style={{ position: "relative" }}>
            <div className="relative w-full pb-[120%] sm:pb-[90%] lg:pb-[72%]">
              ...
              />
              <span className="pointer-events-none absolute inset-0  /40  /50 mix-blend-soft-light dark:/10" />
            ...
            <ul className="space-y-4">
              {protocols.map((protocol, index) => (
                ...
                >
                  ...
                  />
                  <div className="flex items-center justify-between">
                    <h4 className="text-sm font-semibold uppercase tracking-[0.25em] flex items-center gap-2">
