...
type StarButtonElementProps = React.ButtonHTMLAttributes<HTMLButtonElement>;
...
export function StarButton({
  ...
  className,
  ...props
}: StarButtonProps & StarButtonElementProps) {
  ...
  return (
    ...
    >
      <div
        className="absolute aspect-square inset-0 animate-star-btn bg-black"
        style={
          {
            offsetPath: 'var(--path)',
            offsetDistance: '0%',
      ...
      <span className="z-10 relative  dark: dark:   inline-block text-transparent bg-clip-text">
        {children}
      </span>
    </button>
  );
